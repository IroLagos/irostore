...
const HomeDecorCategory = () => {
    ...
    const filteredHome = products?.filter((w) => w.Category.name == "Home")
    ...
    return (
        <div className=''>
            ...
            <div className='relative'>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <p className="text-white text-6xl md:text-[200px] font-semibold">HOME DECORATION</p>
                </div>
            </div>
            ...
            <div className='relative flex justify-center items-center mt-12'>
                ...
                <div className='flex flex-col md:flex-row justify-center items-center md:gap-x-8 lg:gap-x-16 mt-4 px-4'>
                    {filteredHome?.slice(currentIndex, currentIndex + (window.innerWidth >= 768 ? 3 : 1))?.map(d => (
