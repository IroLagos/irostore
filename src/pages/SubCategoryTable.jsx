...
const SubCategoryTable = () => {
  ...
  return (
    <div>
        ...
        <div className='p-9'>
        <p className='font-bold text-3xl text-[#5b3e31]'>Sub-Categories</p>
      <div className="mb-4 text-right mt-4">
        ...
        <Link to={'/createsubcategory'}><button className='bg-[#5b3e31] text-white px-6 py-2 rounded-md'>Create Sub-Category</button></Link>
      </div>
