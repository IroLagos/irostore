...
const Dashboard = () => {
  ...
  return (
    <div>
        ...
        <div className='p-9'>
        <p className='font-bold text-3xl text-[#5b3e31]'>Users</p>
      <div className="mb-4 text-right">
        ...
        <select value={countryFilter} onChange={handleCountryFilter} className="ml-2 p-2 border border-[#5b3e31]  rounded">
